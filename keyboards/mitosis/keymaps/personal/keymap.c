...
#define KC_RHYP KC_HYPR // HYPER (actually muhenkan 無変換 and henkan 変換)
#define KC_LHYP KC_HYPR // or NFER/XFER.
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_xN] = {
    ...
    {MACRO01, _______, _______, _______, _______, KC_PAST, KC_P4,   KC_P5,   KC_P6,   KC_PPLS},
    {MACRO02, _______, _______, _______, _______, KC_PMNS, KC_P1,   KC_P2,   KC_P3,   KC_PEQL},
